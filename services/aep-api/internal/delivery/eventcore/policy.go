...
type mergeDecision struct {
	...
	// open afterwards, not a human standing in front of the merge (ADR-0033).
	Unverified bool
}
...
// confidence rule below and ADR-0033.
...
// behind it, and nothing else — see ADR-0033 for why the human gate this
