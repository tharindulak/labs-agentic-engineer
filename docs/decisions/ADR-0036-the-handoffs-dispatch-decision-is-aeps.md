# ADR-0036 — The handoff's dispatch decision is AEP's
...
- [ADR-0031](./ADR-0031-filing-an-issue-is-the-dispatch.md) — filing the issue is
  the dispatch; this ADR decides *whether* that dispatch happens.
- [ADR-0035](./ADR-0035-incident-identity-is-transport-carried.md) — the same
