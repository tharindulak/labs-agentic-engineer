# ADR-0033 — An unverified fix ships, with its issue left open

ADR-0032 put a human in front of the merge: an incident fix that did not declare
...
- **A missing declaration reads as low, not as a fault.** Under ADR-0032 it
